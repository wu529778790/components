/* @wu529778790/site-navbar v0.1.19 */
"use strict";
(() => {
  // src/styles.css
  ...
  var DEFAULT_LINKS = [
    ...
    { href: "https://h5.lot-ml.com/ProductEn/Index/3d58b4cfe8b560c8", label: "\u6D41\u91CF\u5361", icon: "\u{1F4F6}" },
    ...
    { href: "https://freeimg.shenzjd.com/", label: "\u514D\u8D39\u751F\u56FE", icon: "\u{1F193}" }
  ];
  var DEFAULT_BRAND = {
