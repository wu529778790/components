...
`;var O="floating-qr",Ke="__FLOATING_QR_OPTIONS__",ce="__floatingQrAutoInjected__",Ve="(max-width: 767px)";function Je(){return window[Ke]}function ue(r,e,t){let n=r.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}function Xe(r,e,t){let n=r.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var he=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"]];function Ze(r){if(r===null)return null;let e=r.trim().toLowerCase();return e===""||e==="none"||e==="off"?[]:r.split(",").map(t=>t.trim()).filter(Boolean).map(t=>{let n=/github\.com/i.test(t)?"github":/t\.me/i.test(t)?"tg":/x\.com|twitter\.com/i.test(t)?"x":void 0;return{href:t,icon:n,title:n}})}var k=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=de,this.shadow.appendChild(t)}static get observedAttributes(){return["position","close-persistence","hide-on-mobile","z-index","wechat-src","wechat-title","wechat-desc","donate-src","donate-title","donate-desc","link-hrefs",...he.map(([t])=>t)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}render(){if(!this.isConnected)return;let t=this.buildOptions();t.hideOnMobile&&window.matchMedia?.(Ve)?.matches||(this.widget?.destroy(),this.widget=new M(t,this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let t=Je()??{},n=l=>this.getAttribute(l),i={};for(let[l,c]of he){let d=n(l);d!==null&&(i[c]=d)}let o=(l,c)=>{let d=n(`${l}-src`),u=n(`${l}-title`),h=n(`${l}-desc`);if(d===null&&u===null&&h===null)return c;let p={};return d!==null&&(p.src=d),u!==null&&(p.title=u),h!==null&&(p.desc=h),p},a=n("link-hrefs"),s=Ze(a);return{...t,position:n("position")??t.position,closePersistence:ue(this,"close-persistence",t.closePersistence??!1),hideOnMobile:ue(this,"hide-on-mobile",t.hideOnMobile??!0),zIndex:Xe(this,"z-index",t.zIndex??9999),theme:{...t.theme??{},...i},wechat:o("wechat",t.wechat),donate:o("donate",t.donate),links:s??t.links}}};function pe(){if(document.documentElement?.getAttribute("data-fq-auto")==="false"||document.querySelector(O)||window[ce])return;window[ce]=!0;let e=document.createElement(O);document.body.appendChild(e)}customElements.get(O)||(customElements.define(O,k),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",pe):pe());var et="\u5C0F\u6C34\u7BA1\u670D\u52A1\u5668\u625B\u4E0D\u4F4F\u4E86\uFF0C\u5982\u679C\u672C\u7AD9\u5BF9\u4F60\u6709\u7528\u5C31\u652F\u6301\u4E00\u4E0B\uFF0C\u8BA9\u5B83\u518D\u591A\u625B\u51E0\u5929\u3002",tt={src:"https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/blog/imgx-20260817-165134-105w.png",alt:"\u8D5E\u8D4F\u7801"},nt={bg:"#fff",accent:"#185fa5",radius:"16px",border:"rgba(0, 0, 0, 0.1)",overlay:"rgba(0, 0, 0, 0.4)",titleColor:"#1f1f1f",textColor:"#555"},E=class{constructor(e={},t=document.body){this.mask=null;this.closeBtn=null;this.timer=null;this.escHandler=null;this.handleClose=()=>{this.close()};this.handleMaskClick=e=>{e.target===this.mask&&this.close()};this.opts=this.resolve(e),this.container=t;let n=()=>this.render();this.opts.delay>0?this.timer=setTimeout(n,this.opts.delay):n()}isOpen(){return this.mask!==null&&this.mask.isConnected}show(){this.isOpen()||(this.timer&&(clearTimeout(this.timer),this.timer=null),this.render())}close(){this.destroy(),this.opts.onClose?.()}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null),this.escHandler&&(document.removeEventListener("keydown",this.escHandler),this.escHandler=null),this.closeBtn?.removeEventListener("click",this.handleClose),this.closeBtn=null,this.mask?.remove(),this.mask=null}resolve(e){let t=e.qr??tt;return{title:e.title??"\u5C0F\u6C34\u7BA1\u8BF7\u6C42\u652F\u63F4",content:e.content??et,contentHtml:e.contentHtml??"",qr:{src:t.src,alt:t.alt??"\u8D5E\u8D4F\u7801"},width:e.width??380,maskClosable:e.maskClosable??!0,closeOnEsc:e.closeOnEsc??!0,showClose:e.showClose??!0,delay:e.delay??0,zIndex:e.zIndex??1e4,theme:{...nt,...e.theme??{}},onClose:e.onClose}}render(){let{width:e,zIndex:t,theme:n,showClose:i,maskClosable:o}=this.opts,a=document.createElement("div");a.className="fm-mask",a.style.zIndex=String(t),a.style.setProperty("--fm-overlay",n.overlay),a.style.setProperty("--fm-bg",n.bg),a.style.setProperty("--fm-accent",n.accent),a.style.setProperty("--fm-radius",n.radius),a.style.setProperty("--fm-border",n.border),a.style.setProperty("--fm-title-color",n.titleColor),a.style.setProperty("--fm-text-color",n.textColor),a.style.setProperty("--fm-width",`${e}px`),o&&a.addEventListener("click",this.handleMaskClick),a.innerHTML=`
    ...
    `}},it='<svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true" focusable="false"><path d="M6 6l12 12M18 6L6 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>';function W(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function D(r){return W(r)}var me=`.fm-mask {
...
`;var q="floating-modal",ot="__FLOATING_MODAL_OPTIONS__",ge="__floatingModalAutoInjected__";function at(){return window[ot]}function H(r,e,t){let n=r.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}function j(r,e,t){let n=r.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var fe=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"],["theme-overlay","overlay"],["theme-title-color","titleColor"],["theme-text-color","textColor"]],T=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=me,this.shadow.appendChild(t)}static get observedAttributes(){return["auto-show","title","content","content-html","qr-src","qr-alt","width","mask-closable","close-on-esc","show-close","delay","z-index",...fe.map(([t])=>t)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}show(){this.widget?.isOpen()||(this.widget?.destroy(),this.widget=new E(this.buildOptions(),this.shadow))}close(){this.widget?.close()}render(){this.isConnected&&H(this,"auto-show",!0)&&(this.widget?.destroy(),this.widget=new E(this.buildOptions(),this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let t=at()??{},n=l=>this.getAttribute(l),i={};for(let[l,c]of fe){let d=n(l);d!==null&&(i[c]=d)}let o=n("qr-src"),a=n("qr-alt"),s=o===null&&a===null?t.qr:{src:o??t.qr?.src??"",alt:a??t.qr?.alt};return{...t,title:n("title")??t.title,content:n("content")??t.content,contentHtml:n("content-html")??t.contentHtml,qr:s,width:j(this,"width",t.width??380),maskClosable:H(this,"mask-closable",t.maskClosable??!0),closeOnEsc:H(this,"close-on-esc",t.closeOnEsc??!0),showClose:H(this,"show-close",t.showClose??!0),delay:j(this,"delay",t.delay??0),zIndex:j(this,"z-index",t.zIndex??1e4),theme:{...t.theme??{},...i}}}};function be(){if(document.documentElement?.getAttribute("data-fm-auto")==="false"||document.querySelector(q)||window[ge])return;window[ge]=!0;let e=document.createElement(q);document.body.appendChild(e)}customElements.get(q)||(customElements.define(q,T),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",be):be());var st="https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/reward-unlock-qr.jpg",lt="\u5E2E\u5E2E\u5C0F\u6C34\u7BA1\u670D\u52A1\u5668\u5427",dt="\u670D\u52A1\u5668\u6210\u672C\u4E0D\u5C0F\uFF0C\u5982\u679C\u89C9\u5F97\u597D\u7528\uFF0C\u5FAE\u4FE1\u626B\u7801\u770B\u4E2A\u89C6\u9891\u652F\u6301\u4E00\u4E0B\u5427\u3002",jt="",ct="\u5FAE\u4FE1\u626B\u7801\uFF0C\u5728\u5C0F\u7A0B\u5E8F\u5185\u89C2\u770B\u89C6\u9891",ut="\u4E0B\u6B21\u4E00\u5B9A",ht="\u770B\u5B8C\u5566\uFF0C\u652F\u6301\u4F5C\u8005",pt={bg:"#fff",accent:"#185fa5",radius:"16px",border:"rgba(0, 0, 0, 0.1)",overlay:"rgba(0, 0, 0, 0.4)",titleColor:"#1f1f1f",textColor:"#555"},R=class{constructor(e={},t=document.body){this.mask=null;this.status="idle";this.escHandler=null;this.destroyed=!1;this.opts=this.resolve(e),this.container=t}getState(){return this.status}isOpen(){return this.mask!==null&&this.mask.isConnected}unlock(){return this.show(),Promise.resolve({ok:!0,ticket:null,grant:null})}show(){this.destroyed||this.isOpen()||(this.render(),this.status="open")}close(){this.teardown()}destroy(){this.destroyed=!0,this.teardown()}resolve(e){return{qrSrc:e.qrSrc??st,title:e.title??lt,content:e.content??dt,contentHtml:e.contentHtml??"",loadingText:e.loadingText??"",hint:e.hint??ct,dismissText:e.dismissText??ut,confirmText:e.confirmText??ht,hideActions:e.hideActions??!1,width:e.width??380,zIndex:e.zIndex??1e4,theme:{...pt,...e.theme??{}}}}render(){let{width:e,zIndex:t,theme:n}=this.opts,i=document.createElement("div");i.className="fu-mask",i.style.zIndex=String(t),i.style.setProperty("--fu-overlay",n.overlay),i.style.setProperty("--fu-bg",n.bg),i.style.setProperty("--fu-accent",n.accent),i.style.setProperty("--fu-radius",n.radius),i.style.setProperty("--fu-border",n.border),i.style.setProperty("--fu-title-color",n.titleColor),i.style.setProperty("--fu-text-color",n.textColor),i.style.setProperty("--fu-width",`${e}px`),i.innerHTML=`
      <div class="fu-modal" role="dialog" aria-modal="true" aria-label="${ve(this.opts.title)}">
        <button class="fu-close" type="button" aria-label="\u5173\u95ED">\xD7</button>
        <p class="fu-title">${v(this.opts.title)}</p>
        ${this.opts.loadingText?`<div class="fu-loading"><span class="fu-spinner" aria-hidden="true"></span><span class="fu-loading-text">${v(this.opts.loadingText)}</span></div>`:""}
        ${this.opts.content?`<div class="fu-content">${this.buildContent()}</div>`:""}
        <div class="fu-qr"><img class="fu-qr-img" alt="\u652F\u6301\u4E8C\u7EF4\u7801" src="${ve(this.opts.qrSrc)}" /></div>
        ${this.opts.hint?`<div class="fu-hint">${v(this.opts.hint)}</div>`:""}
        ${this.opts.hideActions?"":`<div class="fu-actions">
          <button class="fu-btn fu-btn-ghost" type="button">${v(this.opts.dismissText)}</button>
          <button class="fu-btn fu-btn-primary" type="button">${v(this.opts.confirmText)}</button>
        </div>`}
      </div>
    `,i.querySelector(".fu-close")?.addEventListener("click",()=>this.close()),i.querySelector(".fu-btn-ghost")?.addEventListener("click",()=>this.close()),i.querySelector(".fu-btn-primary")?.addEventListener("click",()=>this.close()),i.addEventListener("click",o=>{o.target===i&&this.close()}),this.escHandler=o=>{o.key==="Escape"&&this.close()},document.addEventListener("keydown",this.escHandler),this.container.appendChild(i),this.mask=i,mt()}teardown(){this.escHandler&&(document.removeEventListener("keydown",this.escHandler),this.escHandler=null),this.mask?.remove(),this.mask=null,this.status="idle",gt()}buildContent(){return this.opts.contentHtml?this.opts.contentHtml:v(this.opts.content).replace(/\n/g,"<br>")}},z=0,y=null;function mt(){if(z+=1,y)return;let e=document.body.style;y={top:e.top,left:e.left,width:e.width,position:e.position,scrollY:window.scrollY},e.top=`-${y.scrollY}px`,e.left="0",e.width="100%",e.position="fixed"}function gt(){if(z<=0||(z-=1,z>0||!y))return;let e=document.body.style,t=y;y=null,e.top=t.top,e.left=t.left,e.width=t.width,e.position=t.position,t.scrollY>0&&requestAnimationFrame(()=>window.scrollTo(0,t.scrollY))}function v(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ve(r){return v(r)}var xe=`.fu-mask {
...
`;var ye="floating-unlock",bt="__FLOATING_UNLOCK_OPTIONS__";function vt(){return window[bt]}function we(r,e,t){let n=r.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var ke=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"],["theme-overlay","overlay"],["theme-title-color","titleColor"],["theme-text-color","textColor"]],L=class extends HTMLElement{constructor(){super();this.widget=null;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=xe,this.shadow.appendChild(t)}static get observedAttributes(){return["qr-src","title","content","content-html","loading-text","hint","btn-dismiss","btn-confirm","hide-actions","width","z-index",...ke.map(([t])=>t)]}disconnectedCallback(){this.widget?.destroy(),this.widget=null}unlock(){return this.ensureWidget().show(),Promise.resolve({ok:!0,ticket:null,grant:null})}show(){this.ensureWidget().show()}close(){this.widget?.close()}ensureWidget(){return this.widget?.destroy(),this.widget=new R(this.buildOptions(),this.shadow),this.widget}buildOptions(){let t=vt()??{},n=o=>this.getAttribute(o),i={};for(let[o,a]of ke){let s=n(o);s!==null&&(i[a]=s)}return{...t,qrSrc:n("qr-src")??t.qrSrc,title:n("title")??t.title,content:n("content")??t.content,contentHtml:n("content-html")??t.contentHtml,loadingText:n("loading-text")??t.loadingText,hint:n("hint")??t.hint,dismissText:n("btn-dismiss")??t.dismissText,confirmText:n("btn-confirm")??t.confirmText,hideActions:this.hasAttribute("hide-actions")||t.hideActions===!0,width:we(this,"width",t.width??380),zIndex:we(this,"z-index",t.zIndex??1e4),theme:{...t.theme??{},...i}}}};customElements.get(ye)||customElements.define(ye,L);function Q(){if(typeof window<"u")return window.WxAuth}var B=`/* ============================================================
  user-avatar \u7EC4\u4EF6\u6837\u5F0F
...
`;function Lt(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function te(r){return Lt(r)}function Me(r){return r.replace(/^www\./i,"")}function ne(r){try{let e=Me(new URL(r,window.location.href).hostname),t=Me(window.location.hostname);return!e||!t?null:e===t?"exact":t.endsWith("."+e)?"sub":null}catch{return null}}function cn(r){return ne(r)!==null}var ie='<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M2 5a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1zm0 5a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1zm0 5a1 1 0 011-1h14a1 1 0 110 2H3a1 1 0 01-1-1z" clip-rule="evenodd"/></svg>',Oe='<svg viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>';var St="https://unpkg.com/wx-auth-sdk@latest/dist/wx-auth.umd.js",re=null,qe=!1;function He(){if(!(typeof window>"u"))return window.WxAuth}function ze(r={}){let{src:e=St,enabled:t=!0,initOptions:n={silent:!0,required:!1},pollInterval:i=100,timeout:o=1e4,onReady:a,onError:s}=r;if(!t)return Promise.resolve(!1);let l=He();return l?(a?.(l),Promise.resolve(!0)):(re||(re=new Promise(c=>{At(e);let d=Date.now(),u=setInterval(()=>{let h=He();if(h){if(clearInterval(u),!qe&&typeof h.init=="function")try{h.init(n),qe=!0}catch(p){console.warn("[site-navbar] WxAuth.init \u8C03\u7528\u5931\u8D25",p)}a?.(h),c(!0)}else if(Date.now()-d>o){clearInterval(u);let p=`wx-auth-sdk \u52A0\u8F7D\u8D85\u65F6\uFF08${o}ms\uFF09`;console.warn(`[site-navbar] ${p}\uFF0C\u5934\u50CF\u767B\u5F55\u529F\u80FD\u4E0D\u53EF\u7528\uFF0C\u5BFC\u822A\u680F\u7167\u5E38\u6E32\u67D3`),s?.(p),c(!1)}},i)})),re)}function At(r){if(typeof document>"u"||Array.from(document.querySelectorAll("script[data-wx-auth-sdk]")).some(n=>n.src===r))return;let t=document.createElement("script");t.src=r,t.async=!0,t.setAttribute("data-wx-auth-sdk",""),t.onerror=()=>{console.warn(`[site-navbar] wx-auth-sdk \u52A0\u8F7D\u5931\u8D25\uFF1A${r}\uFF0C\u5934\u50CF\u529F\u80FD\u4E0D\u53EF\u7528\uFF0C\u5BFC\u822A\u680F\u7167\u5E38\u6E32\u67D3`)},(document.head||document.documentElement).appendChild(t)}var Ct=[{href:"https://shenzjd.com",label:"AI\u60C5\u62A5\u5C40",icon:"\u{1F3E0}"},{href:"https://panhub.shenzjd.com",label:"\u7F51\u76D8\u641C\u7D22",icon:"\u{1F50D}"},{href:"https://parse.shenzjd.com",label:"\u89C6\u9891\u89E3\u6790",icon:"\u{1F3AC}"},{href:"https://h5.lot-ml.com/ProductEn/Index/3d58b4cfe8b560c8",label:"\u6D41\u91CF\u5361",icon:"\u{1F4F6}"},{href:"https://img.shenzjd.com/",label:"Git \u56FE\u5E8A",icon:"\u{1F4F7}"},{href:"https://navhub.shenzjd.com",label:"\u5BFC\u822A\u68EE\u6797",icon:"\u{1F9ED}"},{href:"https://freeimg.shenzjd.com/",label:"\u514D\u8D39\u751F\u56FE",icon:"\u{1F193}"}],Mt={icon:'<img class="sn-brand-img" src="https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/blog/imgx-20260701-180125-c1ub.webp" alt="\u795E\u65CF\u4E5D\u5E1D" />',text:"\u795E\u65CF\u4E5D\u5E1D"},Re="2.2rem",_="user-avatar",Be="https://unpkg.com/@wu529778790/user-avatar@latest/dist/user-avatar.wc.js",Ot=15e3,$=null;function qt(r){return customElements.get(_)?Promise.resolve(!0):($||($=new Promise(e=>{let t=document.createElement("script");t.src=r||Be,t.async=!0,t.onload=()=>{let n=customElements.whenDefined(_).then(()=>!0,()=>!1),i=new Promise(o=>setTimeout(()=>o(!1),Ot));Promise.race([n,i]).then(e)},t.onerror=()=>e(!1),(document.head||document.documentElement).appendChild(t)})),$.then(e=>(e||($=null),e)))}var Ht={primary:"light-dark(#1f2328, #e6edf3)",secondary:"light-dark(#656d76, #8b949e)",accent:"light-dark(#1a6dff, #4d9fff)",hoverBg:"light-dark(rgba(31, 35, 40, 0.06), rgba(255, 255, 255, 0.08))",bg:"light-dark(rgba(255, 255, 255, 0.55), rgba(28, 31, 36, 0.55))",border:"light-dark(rgba(27, 31, 36, 0.14), rgba(255, 255, 255, 0.14))",radius:"12px",fontFamily:'-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", sans-serif'},G=class{constructor(e={},t=document.body){this.avatarEl=null;this.toggleEl=null;this.mobileEl=null;this.mobileOpen=!1;this.onDocClick=e=>{if(!this.mobileOpen)return;let t=e.target;!this.root.contains(t)&&!(this.mobileEl&&this.mobileEl.contains(t))&&this.setMobileOpen(!1)};this.onKeyDown=e=>{e.key==="Escape"&&this.mobileOpen&&this.setMobileOpen(!1)};this.onResize=()=>{this.mobileOpen&&window.innerWidth>this.opts.breakpoint&&this.setMobileOpen(!1)};this.onScroll=()=>{this.mobileOpen&&this.updateMobilePosition()};this.container=t,this.opts=this.resolve(e),this.root=document.createElement("div"),this.root.className="sn-root"}static check(){let e=customElements.get(_);return e&&typeof e.check=="function"?e.check():window.WxAuth?null:"\u672A\u68C0\u6D4B\u5230\u5FAE\u4FE1\u8BA4\u8BC1 SDK\uFF08window.WxAuth\uFF09\uFF0C\u8BF7\u5148\u5F15\u5165 wx-auth-sdk \u5E76\u8C03\u7528 WxAuth.init()"}mount(e){return this.root.isConnected?this:(e?e.appendChild(this.root):this.container instanceof ShadowRoot?this.container.appendChild(this.root):this.container===document.body?document.body.appendChild(this.root):this.container.appendChild(this.root),this.applyTheme(),this.render(),ze(this.opts.wxAuth),this)}unmount(){this.destroy()}destroy(){this.avatarEl?.remove(),this.avatarEl=null,this.mobileEl&&this.mobileEl.parentElement&&this.mobileEl.parentElement.removeChild(this.mobileEl),this.mobileEl=null,document.removeEventListener("click",this.onDocClick),document.removeEventListener("keydown",this.onKeyDown),window.removeEventListener("resize",this.onResize),window.removeEventListener("scroll",this.onScroll,!0),this.root.remove()}resolve(e){return{links:e.links??Ct,brand:e.brand??Mt,avatar:e.avatar??!0,avatarOptions:{size:Re,...e.avatarOptions??{},theme:{size:Re,...e.avatarOptions?.theme??{}},fixed:!1},theme:{...Ht,...e.theme??{}},breakpoint:e.breakpoint??768,portalEl:e.portalEl??document.body,onNavigate:e.onNavigate,wxAuth:e.wxAuth??{}}}applyTheme(){let e=this.opts.theme,t=this.root.style;t.setProperty("--sn-primary",e.primary),t.setProperty("--sn-secondary",e.secondary),t.setProperty("--sn-accent",e.accent),t.setProperty("--sn-hover-bg",e.hoverBg),t.setProperty("--sn-bg",e.bg),t.setProperty("--sn-border",e.border),t.setProperty("--sn-radius",e.radius),t.setProperty("--sn-font-family",e.fontFamily)}render(){this.root.innerHTML="";let e=this.computeActiveHref(),t=document.createElement("div");t.className="sn-bar",this.opts.brand&&t.appendChild(this.renderBrand(this.opts.brand));let n=document.createElement("nav");n.className="sn-links";for(let s of this.opts.links)n.appendChild(this.renderLink(s,s.href===e));if(t.appendChild(n),this.opts.avatar){let s=document.createElement("div");s.className="sn-avatar",t.appendChild(s);let l=document.createElement(_),{src:c,...d}=this.opts.avatarOptions;l.props=d,s.appendChild(l),this.avatarEl=l,qt(c).then(u=>{u||console.warn(`[site-navbar] <user-avatar> \u52A0\u8F7D\u5931\u8D25\uFF0C\u5934\u50CF\u672A\u6E32\u67D3\uFF1A${c||Be}`)})}let i=document.createElement("button");i.className="sn-toggle",i.type="button",i.setAttribute("aria-label","\u83DC\u5355"),i.setAttribute("aria-expanded","false"),i.innerHTML=ie,i.addEventListener("click",s=>{s.stopPropagation(),this.setMobileOpen(!this.mobileOpen)}),t.appendChild(i),this.toggleEl=i,this.root.appendChild(t);let o=document.createElement("div");o.className="sn-mobile",o.setAttribute("role","menu"),o.setAttribute("aria-hidden","true");for(let s of this.opts.links)o.appendChild(this.renderLink(s,s.href===e));let a=document.createElement("style");a.setAttribute("data-sn-portal-styles",""),a.textContent=U,o.appendChild(a),this.opts.portalEl.appendChild(o),this.mobileEl=o,document.addEventListener("click",this.onDocClick),document.addEventListener("keydown",this.onKeyDown),window.addEventListener("resize",this.onResize),window.addEventListener("scroll",this.onScroll,!0)}renderBrand(e){let t=document.createElement("a");t.className="sn-brand";let n=e.href??window.location.origin;t.href=te(n);try{new URL(n,window.location.href).origin===window.location.origin?t.target="_self":(t.target="_blank",t.rel="noopener noreferrer")}catch{t.target="_blank",t.rel="noopener noreferrer"}if(e.icon){let i=document.createElement("span");i.className="sn-brand-icon",i.innerHTML=e.icon,t.appendChild(i)}return e.text&&t.appendChild(document.createTextNode(e.text)),t}renderLink(e,t){let n=document.createElement("a");if(n.className="sn-link",n.href=te(e.href),n.target="_blank",n.rel="noopener noreferrer",t&&n.classList.add("sn-active"),n.setAttribute("aria-current",t?"page":"false"),e.icon){let i=document.createElement("span");i.className="sn-link-icon",i.innerHTML=e.icon,n.appendChild(i)}return n.appendChild(document.createTextNode(e.label)),n.addEventListener("click",i=>this.opts.onNavigate?.(e,i)),n}computeActiveHref(){for(let e of this.opts.links)if(e.active===!0)return e.href;for(let e of this.opts.links)if(e.active!==!1&&ne(e.href)==="exact")return e.href;return null}setMobileOpen(e){this.mobileOpen=e,this.mobileEl&&(this.mobileEl.classList.toggle("sn-open",e),this.mobileEl.setAttribute("aria-hidden",String(!e)),e&&this.updateMobilePosition()),this.toggleEl&&(this.toggleEl.setAttribute("aria-expanded",String(e)),this.toggleEl.innerHTML=e?Oe:ie)}updateMobilePosition(){if(!this.mobileEl)return;let e=this.root.getBoundingClientRect(),t=this.mobileEl.style;t.position="fixed",t.top=`${Math.round(e.bottom+8)}px`,t.left="16px",t.right="16px",t.width="auto"}};var oe="site-navbar",zt="__SITE_NAVBAR_OPTIONS__";function Rt(){return window[zt]}function Ne(r,e,t){let n=r.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}var Pe=[["theme-primary","primary"],["theme-secondary","secondary"],["theme-accent","accent"],["theme-hover-bg","hoverBg"],["theme-bg","bg"],["theme-border","border"],["theme-radius","radius"],["theme-font-family","fontFamily"]],C=class extends HTMLElement{constructor(){super();this.widget=null;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=U,this.shadow.appendChild(t)}static get observedAttributes(){return["brand","brand-icon","avatar","avatar-src","links","wx-auth-enabled",...Pe.map(([t])=>t)]}connectedCallback(){this.mountWidget()}disconnectedCallback(){this.widget?.unmount(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.mountWidget()}mountWidget(){this.widget?.unmount(),this.widget=new G(this.buildOptions(),this.shadow),this.widget.mount()}buildOptions(){let t=Rt()??{},n=x=>this.getAttribute(x),i={};for(let[x,Fe]of Pe){let ae=n(x);ae!==null&&(i[Fe]=ae)}let o=t.brand,a=n("brand");a!==null&&(o={...t.brand??{},text:a});let s=n("brand-icon");s!==null&&(o={...o??{},icon:s});let l=t.links,c=n("links");if(c!==null)try{let x=JSON.parse(c);Array.isArray(x)&&(l=x)}catch{}let d=t.avatarOptions,u=n("avatar-src");u!==null&&(d={...d??{},src:u});let h=t.wxAuth;return n("wx-auth-enabled")!==null&&(h={...h??{},enabled:Ne(this,"wx-auth-enabled",!0)}),{...t,links:l,brand:o,avatar:Ne(this,"avatar",t.avatar??!0),avatarOptions:d,wxAuth:h,theme:{...t.theme??{},...i},onNavigate:t.onNavigate}}};function Bt(){let r="data-sn-placeholder";if(document.getElementById(r))return;let e=document.createElement("style");e.id=r,e.textContent=`${oe}:not(:defined) {
  display: block;
  height: var(--sn-navbar-height, 44px);
  box-sizing: border-box;
}`,(document.head||document.documentElement).appendChild(e)}customElements.get(oe)||(Bt(),customElements.define(oe,C));})();
