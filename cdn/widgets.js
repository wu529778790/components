(()=>{var ke={wechat:{src:"https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/wp/1782738963299-5wrchz.jpg",title:"\u516C\u4F17\u53F7",desc:""},donate:{src:"https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/blog/imgx-20260828-153016-d3e9.jpg",title:"\u5C0F\u7A0B\u5E8F",desc:""}},Ee={bg:"rgba(255, 255, 255, 0.96)",accent:"#333",radius:"12px",border:"rgba(0, 0, 0, 0.1)"},Le=[{href:"https://t.me/shenzjd_com",icon:"tg",title:"Telegram"},{href:"https://github.com/wu529778790",icon:"github",title:"GitHub"},{href:"https://x.com/shenzujiudi",icon:"x",title:"X"}],Z={tg:'<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M21.9 4.6c.3-1.2-.9-2.2-2-1.7L2.7 10.2c-1.2.5-1.1 2.2.1 2.6l4.3 1.4 1.6 5.2c.3 1.1 1.7 1.4 2.5.6l2.4-2.4 4.5 3.3c1 .7 2.4.2 2.7-1L21.9 4.6zM8.6 13.5l8.7-5.4c.1-.1.3.1.2.2l-6.8 6.7c-.2.2-.3.4-.4.7l-.5 2.6c0 .1-.2.1-.2 0l-.9-4.7c-.1-.1 0-.2 0-.1z"/></svg>',github:'<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M12 2C6.5 2 2 6.6 2 12.2c0 4.5 2.9 8.3 6.8 9.7.5.1.7-.2.7-.5v-1.7c-2.8.6-3.4-1.2-3.4-1.2-.5-1.2-1.1-1.5-1.1-1.5-.9-.6.1-.6.1-.6 1 .1 1.5 1 1.5 1 .9 1.6 2.4 1.1 3 .9.1-.7.4-1.1.6-1.4-2.2-.3-4.6-1.1-4.6-5 0-1.1.4-2 1-2.7-.1-.3-.4-1.3.1-2.7 0 0 .8-.3 2.8 1a9.6 9.6 0 0 1 5 0c2-1.3 2.8-1 2.8-1 .5 1.4.2 2.4.1 2.7.6.7 1 1.6 1 2.7 0 3.9-2.4 4.7-4.6 5 .4.3.7.9.7 1.9v2.8c0 .3.2.6.7.5 4-1.4 6.8-5.2 6.8-9.7C22 6.6 17.5 2 12 2z"/></svg>',x:'<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M17.5 3h3.1l-6.7 7.7L21.8 21h-6.2l-4.8-6.3L5.1 21H2l7.2-8.2L2.5 3h6.3l4.4 5.8L17.5 3zm-1.1 16.1h1.7L8.1 4.7H6.3L16.4 19.1z"/></svg>'};function Te(a,e){return a?Z[a]?Z[a]:/^[a-z][a-z0-9+.-]*:\/\//i.test(a)||a.startsWith("data:")?`<img class="fq-link-img" src="${f(a)}" alt="" loading="lazy" />`:a.includes("<")?a:g(a.slice(0,1)):g((e||"\u2022").slice(0,1))}var ee="floating-qr:closed",Me="(max-width: 767px)";function Ce(){return typeof window>"u"?!1:window.matchMedia?.(Me)?.matches??!1}function Se(){if(typeof localStorage>"u")return!1;try{return localStorage.getItem(ee)==="1"}catch{return!1}}function Ae(){if(!(typeof localStorage>"u"))try{localStorage.setItem(ee,"1")}catch{}}var M=class a{constructor(e={},t=document.body){this.el=null;this.closeBtn=null;this.handleClose=()=>{this.close()};this.opts=this.resolve(e),!(this.opts.hideOnMobile&&Ce())&&(this.opts.closePersistence&&Se()||this.render(t))}isMounted(){return this.el!==null&&this.el.isConnected}close(){this.opts.closePersistence&&Ae(),this.destroy()}destroy(){this.closeBtn?.removeEventListener("click",this.handleClose),this.closeBtn=null,this.el?.remove(),this.el=null}update(e){this.destroy();let t=new a(e);this.opts.theme=t.opts.theme,this.opts.themeOverrides=t.opts.themeOverrides,this.opts.position=t.opts.position,this.opts.closePersistence=t.opts.closePersistence,this.opts.hideOnMobile=t.opts.hideOnMobile,this.opts.zIndex=t.opts.zIndex,this.opts.wechat=t.opts.wechat,this.opts.donate=t.opts.donate,this.opts.links=t.opts.links,this.el=t.el,this.closeBtn=t.closeBtn}resolve(e){let t=(n,i)=>{let o=ke[i];return{src:n?.src??o.src,title:n?.title??o.title,desc:n?.desc??o.desc}};return{wechat:t(e.wechat,"wechat"),donate:t(e.donate,"donate"),position:e.position??"right-center",closePersistence:e.closePersistence??!1,hideOnMobile:e.hideOnMobile??!0,zIndex:e.zIndex??9999,theme:{...Ee,...e.theme??{}},themeOverrides:e.theme??{},links:e.links??Le}}render(e=document.body){let{wechat:t,donate:n,position:i,zIndex:o,themeOverrides:r,links:s}=this.opts,l=document.createElement("div");l.className="fq-widget",l.dataset.position=i,l.style.zIndex=String(o);let c=[["--fq-bg",r.bg],["--fq-accent",r.accent],["--fq-radius",r.radius],["--fq-border",r.border]];for(let[d,u]of c)u!==void 0&&l.style.setProperty(d,u);l.innerHTML=`
      ...
      <div class="fq-section">
        ...
        <p class="fq-label">${g(t.title)}</p>
        ${t.desc?`<p class="fq-desc">${g(t.desc)}</p>`:""}
      </div>
      ...
      <div class="fq-section">
        ...
        <p class="fq-label">${g(n.title)}</p>
        ${n.desc?`<p class="fq-desc">${g(n.desc)}</p>`:""}
      </div>`:""}
...
`;var C="floating-qr",He="__FLOATING_QR_OPTIONS__",ne="__floatingQrAutoInjected__",qe="(max-width: 767px)";function Re(){return window[He]}function ie(a,e,t){let n=a.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}function Be(a,e,t){let n=a.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var ae=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"]];function Ne(a){if(a===null)return null;let e=a.trim().toLowerCase();return e===""||e==="none"||e==="off"?[]:a.split(",").map(t=>t.trim()).filter(Boolean).map(t=>{let n=/github\.com/i.test(t)?"github":/t\.me/i.test(t)?"tg":/x\.com|twitter\.com/i.test(t)?"x":void 0;return{href:t,icon:n,title:n}})}var y=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=te,this.shadow.appendChild(t)}static get observedAttributes(){return["position","close-persistence","hide-on-mobile","z-index","wechat-src","wechat-title","wechat-desc","donate-src","donate-title","donate-desc","link-hrefs",...ae.map(([t])=>t)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}render(){if(!this.isConnected)return;let t=this.buildOptions();t.hideOnMobile&&window.matchMedia?.(qe)?.matches||(this.widget?.destroy(),this.widget=new M(t,this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let t=Re()??{},n=l=>this.getAttribute(l),i={};for(let[l,c]of ae){let d=n(l);d!==null&&(i[c]=d)}let o=(l,c)=>{let d=n(`${l}-src`),u=n(`${l}-title`),p=n(`${l}-desc`);if(d===null&&u===null&&p===null)return c;let b={};return d!==null&&(b.src=d),u!==null&&(b.title=u),p!==null&&(b.desc=p),b},r=n("link-hrefs"),s=Ne(r);return{...t,position:n("position")??t.position,closePersistence:ie(this,"close-persistence",t.closePersistence??!1),hideOnMobile:ie(this,"hide-on-mobile",t.hideOnMobile??!0),zIndex:Be(this,"z-index",t.zIndex??9999),theme:{...t.theme??{},...i},wechat:o("wechat",t.wechat),donate:o("donate",t.donate),links:s??t.links}}};function oe(){if(document.documentElement?.getAttribute("data-fq-auto")==="false"||document.querySelector(C)||window[ne])return;window[ne]=!0;let e=document.createElement(C);document.body.appendChild(e)}customElements.get(C)||(customElements.define(C,y),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",oe):oe());var Pe="\u5C0F\u6C34\u7BA1\u670D\u52A1\u5668\u625B\u4E0D\u4F4F\u4E86\uFF0C\u5982\u679C\u672C\u7AD9\u5BF9\u4F60\u6709\u7528\u5C31\u652F\u6301\u4E00\u4E0B\uFF0C\u8BA9\u5B83\u518D\u591A\u625B\u51E0\u5929\u3002",Ie={src:"https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/blog/imgx-20260817-165134-105w.png",alt:"\u8D5E\u8D4F\u7801"},Fe={bg:"#fff",accent:"#185fa5",radius:"16px",border:"rgba(0, 0, 0, 0.1)",overlay:"rgba(0, 0, 0, 0.4)",titleColor:"#1f1f1f",textColor:"#555"},w=class{constructor(e={},t=document.body){this.mask=null;this.closeBtn=null;this.timer=null;this.escHandler=null;this.handleClose=()=>{this.close()};this.handleMaskClick=e=>{e.target===this.mask&&this.close()};this.opts=this.resolve(e),this.container=t;let n=()=>this.render();this.opts.delay>0?this.timer=setTimeout(n,this.opts.delay):n()}isOpen(){return this.mask!==null&&this.mask.isConnected}show(){this.isOpen()||(this.timer&&(clearTimeout(this.timer),this.timer=null),this.render())}close(){this.destroy(),this.opts.onClose?.()}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null),this.escHandler&&(document.removeEventListener("keydown",this.escHandler),this.escHandler=null),this.closeBtn?.removeEventListener("click",this.handleClose),this.closeBtn=null,this.mask?.remove(),this.mask=null}resolve(e){let t=e.qr??Ie;return{title:e.title??"\u5C0F\u6C34\u7BA1\u8BF7\u6C42\u652F\u63F4",content:e.content??Pe,contentHtml:e.contentHtml??"",qr:{src:t.src,alt:t.alt??"\u8D5E\u8D4F\u7801"},width:e.width??380,maskClosable:e.maskClosable??!0,closeOnEsc:e.closeOnEsc??!0,showClose:e.showClose??!0,delay:e.delay??0,zIndex:e.zIndex??1e4,theme:{...Fe,...e.theme??{}},onClose:e.onClose}}render(){let{width:e,zIndex:t,theme:n,showClose:i,maskClosable:o}=this.opts,r=document.createElement("div");r.className="fm-mask",r.style.zIndex=String(t),r.style.setProperty("--fm-overlay",n.overlay),r.style.setProperty("--fm-bg",n.bg),r.style.setProperty("--fm-accent",n.accent),r.style.setProperty("--fm-radius",n.radius),r.style.setProperty("--fm-border",n.border),r.style.setProperty("--fm-title-color",n.titleColor),r.style.setProperty("--fm-text-color",n.textColor),r.style.setProperty("--fm-width",`${e}px`),o&&r.addEventListener("click",this.handleMaskClick),r.innerHTML=`
      <div class="fm-modal" role="dialog" aria-modal="true" aria-label="${I(this.opts.title)}">
        ${i?`<button class="fm-close" type="button" aria-label="\u5173\u95ED\u5F39\u7A97">${Ue}</button>`:""}
        <p class="fm-title">${P(this.opts.title)}</p>
        <div class="fm-content">${this.buildContent()}</div>
        ${this.buildQR()}
      </div>
    `,this.closeBtn=r.querySelector(".fm-close"),this.closeBtn?.addEventListener("click",this.handleClose),this.container.appendChild(r),this.mask=r,this.opts.closeOnEsc&&(this.escHandler=s=>{s.key==="Escape"&&this.close()},document.addEventListener("keydown",this.escHandler))}buildContent(){return this.opts.contentHtml?this.opts.contentHtml:P(this.opts.content).replace(/\n/g,"<br>")}buildQR(){let{qr:e}=this.opts;return`
      <div class="fm-qr">
        <img class="fm-qr-img" src="${I(e.src)}" alt="${I(e.alt)}" loading="lazy" />
      </div>
    `}},Ue='<svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true" focusable="false"><path d="M6 6l12 12M18 6L6 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>';function P(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function I(a){return P(a)}var re=`.fm-mask {
...
`;var S="floating-modal",$e="__FLOATING_MODAL_OPTIONS__",se="__floatingModalAutoInjected__";function Ge(){return window[$e]}function A(a,e,t){let n=a.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}function F(a,e,t){let n=a.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var le=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"],["theme-overlay","overlay"],["theme-title-color","titleColor"],["theme-text-color","textColor"]],k=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=re,this.shadow.appendChild(t)}static get observedAttributes(){return["auto-show","title","content","content-html","qr-src","qr-alt","width","mask-closable","close-on-esc","show-close","delay","z-index",...le.map(([t])=>t)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}show(){this.widget?.isOpen()||(this.widget?.destroy(),this.widget=new w(this.buildOptions(),this.shadow))}close(){this.widget?.close()}render(){this.isConnected&&A(this,"auto-show",!0)&&(this.widget?.destroy(),this.widget=new w(this.buildOptions(),this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let t=Ge()??{},n=l=>this.getAttribute(l),i={};for(let[l,c]of le){let d=n(l);d!==null&&(i[c]=d)}let o=n("qr-src"),r=n("qr-alt"),s=o===null&&r===null?t.qr:{src:o??t.qr?.src??"",alt:r??t.qr?.alt};return{...t,title:n("title")??t.title,content:n("content")??t.content,contentHtml:n("content-html")??t.contentHtml,qr:s,width:F(this,"width",t.width??380),maskClosable:A(this,"mask-closable",t.maskClosable??!0),closeOnEsc:A(this,"close-on-esc",t.closeOnEsc??!0),showClose:A(this,"show-close",t.showClose??!0),delay:F(this,"delay",t.delay??0),zIndex:F(this,"z-index",t.zIndex??1e4),theme:{...t.theme??{},...i}}}};function de(){if(document.documentElement?.getAttribute("data-fm-auto")==="false"||document.querySelector(S)||window[se])return;window[se]=!0;let e=document.createElement(S);document.body.appendChild(e)}customElements.get(S)||(customElements.define(S,k),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",de):de());function U(){if(typeof window<"u")return window.WxAuth}var O=`/* ============================================================
  user-avatar \u7EC4\u4EF6\u6837\u5F0F
...
`;var z="wxauth-token",H="wxauth-openid";function ce(a){return!a||a.length<20?!1:/^[^.]+\.[0-9]+\.[0-9a-f]{64}$/.test(a)}function E(){let a=document.cookie.split("; "),e=[],t=[];for(let i of a){let o=i.indexOf("=");if(o<0)continue;let r=i.slice(0,o).trim(),s=i.slice(o+1);r===z?e.push(s):r===H&&t.push(s)}return e.find(ce)||e[0]||t.find(ce)||t[0]||""}function _(){let a=window.location.hostname;if(a==="localhost"||/^\d+\.\d+\.\d+\.\d+$/.test(a))return"";let e=a.split(".");return e.length>=2?"."+e.slice(-2).join("."):""}function $(){v(z,!1),v(z,!0),v(H,!1),v(H,!0)}function ue(){let a=document.cookie.split("; ");for(let e of a){let t=e.indexOf("=");if(t<0)continue;let n=e.slice(0,t).trim();if(n!==z&&n!==H)continue;let i=e.slice(t+1);/^[^.]+\.[0-9]+\.[0-9a-f]{64}$/.test(i)||(v(n,!1),v(n,!0))}}function v(a,e){let t=e&&_()?`;domain=${_()}`:"",n=window.location.protocol==="https:"?";Secure":"";document.cookie=`${a}=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/${t}${n};SameSite=Strict`}function h(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function x(a){return h(a)}var he='<svg class="ua-icon-user" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/></svg>',pe='<svg class="ua-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.533 1.533 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.533 1.533 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>',me='<svg class="ua-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M3 3a1 1 0 011-1h4a1 1 0 110 2H4v12h4a1 1 0 110 2H4a1 1 0 01-1-1V3zm10.293 9.293a1 1 0 001.414 0l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293a1 1 0 000 1.414zM21 10a1 1 0 01-1-1v2a1 1 0 110 0v-2a1 1 0 011 0 1 1 0 010 1v-1h27a1 1 0 010 2H20a1 1 0 01-1-1v-2a1 1 0 010-1z" clip-rule="evenodd"/></svg>',G='<svg class="ua-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>',j='<svg class="ua-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0016 8c0-4.42-3.58-8-8-8z" clip-rule="evenodd"/></svg>';var W={btnBg:"light-dark(#ffffff, #262a30)",size:"2.5rem",accent:"light-dark(#1f2328, #e6edf3)",btnBorder:"light-dark(rgba(27, 31, 36, 0.12), rgba(255, 255, 255, 0.14))",radius:"16px",bg:"light-dark(#ffffff, #1c1e22)",text:"light-dark(#1f2328, #e6edf3)",subText:"light-dark(#656d76, #8b949e)",overlay:"light-dark(rgba(31, 35, 40, 0.45), rgba(0, 0, 0, 0.6))",danger:"light-dark(#dc2626, #f85149)",success:"light-dark(#1a7f37, #3fb950)"},m=class{constructor(e={},t=document.body){this.user=null;this.status="checking";this.menuEl=null;this.settingsEl=null;this.menuCleanup=null;this.settingsCleanup=null;this.confirmEl=null;this.confirmCleanup=null;this.githubMsgListener=null;this.saving=!1;this.saveBtnTimer=null;this.nicknameDraft="";this.onWindowFocus=()=>{this.fetchUser()};this.onVisibility=()=>{document.visibilityState==="visible"&&this.fetchUser()};this.container=t,this.opts=this.resolve(e),ue(),this.root=document.createElement("div"),this.root.className="ua-root"}static check(e){return e||U()?null:"\u672A\u68C0\u6D4B\u5230\u5FAE\u4FE1\u8BA4\u8BC1 SDK\uFF08window.WxAuth\uFF09\uFF0C\u8BF7\u5148\u5F15\u5165 wx-auth-sdk \u5E76\u8C03\u7528 WxAuth.init()"}mount(e){return this.root.isConnected?this:(e?e.appendChild(this.root):this.container instanceof ShadowRoot?this.container.appendChild(this.root):this.container===document.body?document.body.appendChild(this.root):this.container.appendChild(this.root),this.applyTheme(),this.render(),this.fetchUser(),window.addEventListener("focus",this.onWindowFocus),document.addEventListener("visibilitychange",this.onVisibility),this)}unmount(){this.destroy()}async login(){return this.triggerLogin()}async refresh(){await this.fetchUser()}destroy(){this.closeMenu(),this.closeSettings(),this.githubMsgListener&&(window.removeEventListener("message",this.githubMsgListener),this.githubMsgListener=null),window.removeEventListener("focus",this.onWindowFocus),document.removeEventListener("visibilitychange",this.onVisibility),this.root.remove()}resolve(e){let t=e.sdk??U(),n=e.apiBase!==void 0&&e.apiBase!==""?e.apiBase:"https://wx-auth.shenzjd.com";return{sdk:t,apiBase:n,fixed:e.fixed??!0,offset:e.offset??"1rem 1.5rem",size:e.size??W.size,zIndex:e.zIndex??12e3,portal:e.portal??!0,portalEl:e.portalEl,theme:{...W,...e.theme??{},size:e.size??e.theme?.size??W.size},onLogin:e.onLogin,onLogout:e.onLogout,onGithubBound:e.onGithubBound}}applyTheme(){let e=this.opts.theme,t=this.root.style;t.setProperty("--ua-btn-bg",e.btnBg),t.setProperty("--ua-size",e.size),t.setProperty("--ua-accent",e.accent),t.setProperty("--ua-btn-border",e.btnBorder),t.setProperty("--ua-radius",e.radius),t.setProperty("--ua-bg",e.bg),t.setProperty("--ua-text",e.text),t.setProperty("--ua-sub",e.subText),t.setProperty("--ua-overlay",e.overlay),t.setProperty("--ua-danger",e.danger),t.setProperty("--ua-success",e.success)}usePortal(){return this.opts.portal}getPortalRoot(){return this.opts.portalEl??document.body}appendOverlay(e){if(this.usePortal()){let t=this.opts.theme,n=e.style;n.setProperty("--ua-btn-bg",t.btnBg),n.setProperty("--ua-size",t.size),n.setProperty("--ua-accent",t.accent),n.setProperty("--ua-btn-border",t.btnBorder),n.setProperty("--ua-radius",t.radius),n.setProperty("--ua-bg",t.bg),n.setProperty("--ua-text",t.text),n.setProperty("--ua-sub",t.subText),n.setProperty("--ua-overlay",t.overlay),n.setProperty("--ua-danger",t.danger),n.setProperty("--ua-success",t.success);let i=document.createElement("style");i.setAttribute("data-ua-portal-style",""),i.textContent=O,e.appendChild(i),this.getPortalRoot().appendChild(e)}else this.root.appendChild(e)}async triggerLogin(){let e=this.opts.sdk;if(!e)return console.warn("[UserAvatar] \u672A\u627E\u5230\u5FAE\u4FE1\u8BA4\u8BC1 SDK"),!1;let t=await e.requireAuth();return t&&(await this.fetchUser(),this.user&&this.opts.onLogin?.(this.user)),t}async logout(){let e=this.opts.sdk;e?.revoke?await e.revoke():(e?.clearToken(),$()),this.user=null,this.status="unauth",this.closeMenu(),this.closeSettings(),this.render(),this.opts.onLogout?.()}async fetchUser(){let e=E();if(!e){this.user=null,this.status="unauth",this.render();return}this.status!=="auth"&&(this.status="checking",this.render());let t=this.user;try{let n=this.opts.apiBase||window.location.origin,o=await(await fetch(`${n}/api/auth/userinfo?token=${encodeURIComponent(e)}`)).json();if(!o.authenticated){console.warn("[UserAvatar] token \u5DF2\u5931\u6548\uFF0C\u81EA\u52A8\u6E05\u7406\u672C\u5730\u51ED\u8BC1",o.error??""),$(),this.user=null,this.status="unauth",this.closeSettings(),this.render();return}if(this.user=o.user?o.user:null,this.status=this.user?"auth":"unauth",this.status==="auth"&&t&&JSON.stringify(t)===JSON.stringify(this.user))return}catch(n){console.error("[UserAvatar] \u62C9\u53D6\u7528\u6237\u8BE6\u60C5\u5931\u8D25",n),this.status!=="auth"&&(this.user=null,this.status="unauth")}this.render()}async saveNickname(){let e=E(),t=this.nicknameDraft.trim();if(!e)return;if(t.length<2||t.length>20){this.setMsg("\u6635\u79F0\u9700\u4E3A 2-20 \u4E2A\u5B57\u7B26");return}if(this.saving)return;this.saving=!0,this.updateSaveBtn(),this.setMsg("");let n=!1;try{let i=this.opts.apiBase||window.location.origin,r=await(await fetch(`${i}/api/auth/profile`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,action:"set-nickname",nickname:t})})).json();r.success?(n=!0,this.nicknameDraft=t,await this.fetchUser()):this.setMsg(r.message||"\u4FDD\u5B58\u5931\u8D25")}catch(i){console.error("[UserAvatar] \u4FDD\u5B58\u6635\u79F0\u5931\u8D25",i),this.setMsg("\u4FDD\u5B58\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5")}finally{this.saving=!1,this.updateSaveBtn(n)}}async unbindGithub(){let e=E();if(e)try{let t=this.opts.apiBase||window.location.origin,i=await(await fetch(`${t}/api/auth/profile`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:e,action:"unbind-github"})})).json();i.success?await this.fetchUser():window.alert(i.message||"\u89E3\u7ED1\u5931\u8D25")}catch(t){console.error("[UserAvatar] \u89E3\u7ED1\u5931\u8D25",t),window.alert("\u89E3\u7ED1\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5")}}render(){this.root.innerHTML="",this.closeMenu();let e=this.opts.fixed?`position:fixed;top:${this.offsetTop()};right:${this.offsetRight()};z-index:${this.opts.zIndex}`:"",t=this.status==="checking",n=t?"ua-avatar ua-avatar-checking":this.status==="auth"?"ua-avatar":"ua-avatar ua-avatar-unauth";this.root.innerHTML=`
    ...
    `,this.usePortal()){let s=this.root.querySelector(".ua-avatar")?.getBoundingClientRect();s&&s.width>0?(t.style.position="fixed",t.style.top=`${s.bottom+8}px`,t.style.left="auto",t.style.right=`${Math.max(window.innerWidth-s.right,0)}px`,t.style.minWidth="12rem",t.style.maxWidth="min(20rem, calc(100vw - 2rem))",t.dataset.uaPortal="true"):this.usePortalMenuInlineFallback(t)}let i=r=>{let s=r.composedPath();!s.includes(this.root)&&!(this.menuEl&&s.includes(this.menuEl))&&this.closeMenu()},o=r=>{r.key==="Escape"&&this.closeMenu()};document.addEventListener("mousedown",i),document.addEventListener("keydown",o),this.menuCleanup=()=>{document.removeEventListener("mousedown",i),document.removeEventListener("keydown",o)},t.querySelector('[data-action="settings"]')?.addEventListener("click",()=>{this.openSettings()}),t.querySelector('[data-action="logout"]')?.addEventListener("click",()=>{this.openLogoutConfirm()}),this.appendOverlay(t),this.menuEl=t}usePortalMenuInlineFallback(e){e.style.position="absolute",e.style.top="",e.style.left="",e.style.right="0",e.style.minWidth="12rem",e.style.maxWidth="",this.root.appendChild(e)}closeMenu(){this.menuEl?.remove(),this.menuEl=null,this.menuCleanup?.(),this.menuCleanup=null}openLogoutConfirm(){this.closeMenu(),this.closeConfirm();let e=document.createElement("div");e.className="ua-mask",e.style.zIndex=String(this.opts.zIndex+10),e.innerHTML=`
      <div class="ua-dialog ua-confirm" role="alertdialog" aria-modal="true" aria-label="\u9000\u51FA\u767B\u5F55">
        <div class="ua-dialog-head">
          ...
          <button type="button" class="ua-close" data-action="cancel" aria-label="\u5173\u95ED">${G}</button>
        </div>
    ...
    `,this.confirmEl=e,this.appendOverlay(e);let t=()=>this.closeConfirm();e.querySelector('[data-action="confirm"]')?.addEventListener("click",()=>{t(),this.logout()}),e.querySelectorAll('[data-action="cancel"]').forEach(o=>{o.addEventListener("click",t)});let n=o=>{o.composedPath()[0]===e&&t()},i=o=>{o.key==="Escape"&&t()};document.addEventListener("mousedown",n),document.addEventListener("keydown",i),this.confirmCleanup=()=>{document.removeEventListener("mousedown",n),document.removeEventListener("keydown",i)}}closeConfirm(){this.confirmEl?.remove(),this.confirmEl=null,this.confirmCleanup?.(),this.confirmCleanup=null}openSettings(){let e=this.user;if(!e)return;this.closeMenu(),this.closeSettings(),this.nicknameDraft=e.nickname||"";let t=document.createElement("div");t.className="ua-mask",t.style.zIndex=String(this.opts.zIndex+10),t.innerHTML=this.buildSettingsHtml(e),this.settingsEl=t,this.appendOverlay(t),this.bindSettingsEvents(t);let n=o=>{o.composedPath()[0]===t&&this.closeSettings()},i=o=>{o.key==="Escape"&&this.closeSettings()};document.addEventListener("mousedown",n),document.addEventListener("keydown",i),this.settingsCleanup=()=>{document.removeEventListener("mousedown",n),document.removeEventListener("keydown",i)}}buildSettingsHtml(e){let t=e.avatarUrl||e.headimgurl||e.github?.avatar,n=t?`<img class="ua-big-avatar" src="${x(t)}" alt="" referrerpolicy="no-referrer" />`:`<div class="ua-big-avatar ua-big-avatar-fallback">${h((e.nickname||e.github?.login||"?").charAt(0).toUpperCase())}</div>`,i=e.github?`
        ...
        <div class="ua-github-unbound">
          ...
          <button type="button" class="ua-gh-bind" data-action="bind">${j}<span>\u7ED1\u5B9A GitHub</span></button>
        </div>`;return`
      <div class="ua-dialog" role="dialog" aria-modal="true" aria-label="\u8BBE\u7F6E">
        <div class="ua-dialog-head">
          <h3 class="ua-dialog-title">\u8BBE\u7F6E</h3>
          <button type="button" class="ua-close" data-action="close" aria-label="\u5173\u95ED">${G}</button>
        </div>
        <div class="ua-dialog-body">
          <!-- \u7528\u6237\u4FE1\u606F\u5361\u7247 -->
          ...
          <!-- GitHub \u7ED1\u5B9A -->
          <div class="ua-field-group">
            <div class="ua-section-title">${j}<span>GitHub</span></div>
            ${i}
          </div>

          <!-- \u8BBE\u7F6E\u540D\u5B57 -->
          <div class="ua-field-group">
            <div class="ua-section-title">${he}<span>\u8BBE\u7F6E\u540D\u5B57</span></div>
