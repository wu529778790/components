...
`;var L="floating-qr",ge="__FLOATING_QR_OPTIONS__",P="__floatingQrAutoInjected__",me="(max-width: 767px)";function pe(){return window[ge]}function G(o,t,e){let i=o.getAttribute(t);return i===null?e:i===""||i==="true"||i==="1"}function fe(o,t,e){let i=o.getAttribute(t);if(i===null||i==="")return e;let n=Number(i);return Number.isFinite(n)?n:e}var N=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"]];function ve(o){if(o===null)return null;let t=o.trim().toLowerCase();return t===""||t==="none"||t==="off"?[]:o.split(",").map(e=>e.trim()).filter(Boolean).map(e=>{let i=/github\.com/i.test(e)?"github":/t\.me/i.test(e)?"tg":/x\.com|twitter\.com/i.test(e)?"x":void 0;return{href:e,icon:i,title:i}})}var v=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=U,this.shadow.appendChild(e)}static get observedAttributes(){return["position","close-persistence","hide-on-mobile","z-index","wechat-src","wechat-title","wechat-desc","donate-src","donate-title","donate-desc","link-hrefs",...N.map(([e])=>e)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}render(){if(!this.isConnected)return;let e=this.buildOptions();e.hideOnMobile&&window.matchMedia?.(me)?.matches||(this.widget?.destroy(),this.widget=new E(e,this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let e=pe()??{},i=a=>this.getAttribute(a),n={};for(let[a,h]of N){let l=i(a);l!==null&&(n[h]=l)}let s=(a,h)=>{let l=i(`${a}-src`),p=i(`${a}-title`),T=i(`${a}-desc`);if(l===null&&p===null&&T===null)return h;let k={};return l!==null&&(k.src=l),p!==null&&(k.title=p),T!==null&&(k.desc=T),k},r=i("link-hrefs"),d=ve(r);return{...e,position:i("position")??e.position,closePersistence:G(this,"close-persistence",e.closePersistence??!1),hideOnMobile:G(this,"hide-on-mobile",e.hideOnMobile??!0),zIndex:fe(this,"z-index",e.zIndex??9999),theme:{...e.theme??{},...n},wechat:s("wechat",e.wechat),donate:s("donate",e.donate),links:d??e.links}}};function Q(){if(document.documentElement?.getAttribute("data-fq-auto")==="false"||document.querySelector(L)||window[P])return;window[P]=!0;let t=document.createElement(L);document.body.appendChild(t)}customElements.get(L)||(customElements.define(L,v),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Q):Q());var be="\u5C0F\u6C34\u7BA1\u670D\u52A1\u5668\u625B\u4E0D\u4F4F\u4E86\uFF0C\u5982\u679C\u672C\u7AD9\u5BF9\u4F60\u6709\u7528\u5C31\u652F\u6301\u4E00\u4E0B\uFF0C\u8BA9\u5B83\u518D\u591A\u625B\u51E0\u5929\u3002",xe={src:"https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/blog/imgx-20260817-165134-105w.png",alt:"\u8D5E\u8D4F\u7801"},we={bg:"#fff",accent:"#185fa5",radius:"16px",border:"rgba(0, 0, 0, 0.1)",overlay:"rgba(0, 0, 0, 0.4)",titleColor:"#1f1f1f",textColor:"#555"},b=class{constructor(t={},e=document.body){this.mask=null;this.closeBtn=null;this.timer=null;this.escHandler=null;this.handleClose=()=>{this.close()};this.handleMaskClick=t=>{t.target===this.mask&&this.close()};this.opts=this.resolve(t),this.container=e;let i=()=>this.render();this.opts.delay>0?this.timer=setTimeout(i,this.opts.delay):i()}isOpen(){return this.mask!==null&&this.mask.isConnected}show(){this.isOpen()||(this.timer&&(clearTimeout(this.timer),this.timer=null),this.render())}close(){this.destroy(),this.opts.onClose?.()}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null),this.escHandler&&(document.removeEventListener("keydown",this.escHandler),this.escHandler=null),this.closeBtn?.removeEventListener("click",this.handleClose),this.closeBtn=null,this.mask?.remove(),this.mask=null}resolve(t){let e=t.qr??xe;return{title:t.title??"\u5C0F\u6C34\u7BA1\u8BF7\u6C42\u652F\u63F4",content:t.content??be,contentHtml:t.contentHtml??"",qr:{src:e.src,alt:e.alt??"\u8D5E\u8D4F\u7801"},width:t.width??380,maskClosable:t.maskClosable??!0,closeOnEsc:t.closeOnEsc??!0,showClose:t.showClose??!0,delay:t.delay??0,zIndex:t.zIndex??1e4,theme:{...we,...t.theme??{}},onClose:t.onClose}}render(){let{width:t,zIndex:e,theme:i,showClose:n,maskClosable:s}=this.opts,r=document.createElement("div");r.className="fm-mask",r.style.zIndex=String(e),r.style.setProperty("--fm-overlay",i.overlay),r.style.setProperty("--fm-bg",i.bg),r.style.setProperty("--fm-accent",i.accent),r.style.setProperty("--fm-radius",i.radius),r.style.setProperty("--fm-border",i.border),r.style.setProperty("--fm-title-color",i.titleColor),r.style.setProperty("--fm-text-color",i.textColor),r.style.setProperty("--fm-width",`${t}px`),s&&r.addEventListener("click",this.handleMaskClick),r.innerHTML=`
      <div class="fm-modal" role="dialog" aria-modal="true" aria-label="${S(this.opts.title)}">
        ${n?`<button class="fm-close" type="button" aria-label="\u5173\u95ED\u5F39\u7A97">${ye}</button>`:""}
    ...
    `,this.closeBtn=r.querySelector(".fm-close"),this.closeBtn?.addEventListener("click",this.handleClose),this.container.appendChild(r),this.mask=r,this.opts.closeOnEsc&&(this.escHandler=d=>{d.key==="Escape"&&this.close()},document.addEventListener("keydown",this.escHandler))}buildContent(){return this.opts.contentHtml?this.opts.contentHtml:C(this.opts.content).replace(/\n/g,"<br>")}buildQR(){let{qr:t}=this.opts;return`
      <div class="fm-qr">
        <img class="fm-qr-img" src="${S(t.src)}" alt="${S(t.alt)}" loading="lazy" />
      </div>
    `}},ye='<svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true" focusable="false"><path d="M6 6l12 12M18 6L6 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>';function C(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function S(o){return C(o)}var j=`.fm-mask {
...
`;var M="floating-modal",Ee="__FLOATING_MODAL_OPTIONS__",W="__floatingModalAutoInjected__";function Le(){return window[Ee]}function q(o,t,e){let i=o.getAttribute(t);return i===null?e:i===""||i==="true"||i==="1"}function O(o,t,e){let i=o.getAttribute(t);if(i===null||i==="")return e;let n=Number(i);return Number.isFinite(n)?n:e}var D=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"],["theme-overlay","overlay"],["theme-title-color","titleColor"],["theme-text-color","textColor"]],x=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=j,this.shadow.appendChild(e)}static get observedAttributes(){return["auto-show","title","content","content-html","qr-src","qr-alt","width","mask-closable","close-on-esc","show-close","delay","z-index",...D.map(([e])=>e)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}show(){this.widget?.isOpen()||(this.widget?.destroy(),this.widget=new b(this.buildOptions(),this.shadow))}close(){this.widget?.close()}render(){this.isConnected&&q(this,"auto-show",!0)&&(this.widget?.destroy(),this.widget=new b(this.buildOptions(),this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let e=Le()??{},i=a=>this.getAttribute(a),n={};for(let[a,h]of D){let l=i(a);l!==null&&(n[h]=l)}let s=i("qr-src"),r=i("qr-alt"),d=s===null&&r===null?e.qr:{src:s??e.qr?.src??"",alt:r??e.qr?.alt};return{...e,title:i("title")??e.title,content:i("content")??e.content,contentHtml:i("content-html")??e.contentHtml,qr:d,width:O(this,"width",e.width??380),maskClosable:q(this,"mask-closable",e.maskClosable??!0),closeOnEsc:q(this,"close-on-esc",e.closeOnEsc??!0),showClose:q(this,"show-close",e.showClose??!0),delay:O(this,"delay",e.delay??0),zIndex:O(this,"z-index",e.zIndex??1e4),theme:{...e.theme??{},...n}}}};function K(){if(document.documentElement?.getAttribute("data-fm-auto")==="false"||document.querySelector(M)||window[W])return;window[W]=!0;let t=document.createElement(M);document.body.appendChild(t)}customElements.get(M)||(customElements.define(M,x),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",K):K());function z(){if(typeof window<"u")return window.WxAuth}var A="wxauth-token",R="wxauth-openid";function w(){let o=document.cookie.split("; ");for(let t of o)if(t.startsWith(`${A}=`))return t.slice(A.length+1);for(let t of o)if(t.startsWith(`${R}=`))return t.slice(R.length+1);return""}function H(){let o=window.location.hostname;if(o==="localhost"||/^\d+\.\d+\.\d+\.\d+$/.test(o))return"";let t=o.split(".");return t.length>=2?"."+t.slice(-2).join("."):""}function V(){Y(A),Y(R)}function Y(o){let t=H()?`;domain=${H()}`:"",e=window.location.protocol==="https:"?";Secure":"";document.cookie=`${o}=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/${t}${e};SameSite=Strict`}function c(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function f(o){return c(o)}var B='<svg class="ua-icon-user" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/></svg>',J='<svg class="ua-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.533 1.533 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.533 1.533 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"/></svg>',X='<svg class="ua-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M3 3a1 1 0 011-1h4a1 1 0 110 2H4v12h4a1 1 0 110 2H4a1 1 0 01-1-1V3zm10.293 9.293a1 1 0 001.414 0l3-3a1 1 0 000-1.414l-3-3a1 1 0 10-1.414 1.414L14.586 9H7a1 1 0 100 2h7.586l-1.293 1.293a1 1 0 000 1.414zM21 10a1 1 0 01-1-1v2a1 1 0 110 0v-2a1 1 0 011 0 1 1 0 010 1v-1h27a1 1 0 010 2H20a1 1 0 01-1-1v-2a1 1 0 010-1z" clip-rule="evenodd"/></svg>',Z='<svg class="ua-icon" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>',F='<svg class="ua-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0016 8c0-4.42-3.58-8-8-8z" clip-rule="evenodd"/></svg>';var ee={btnBg:"#ffffff",size:"2.5rem",accent:"#1f2328",btnBorder:"rgba(27, 31, 36, 0.12)",radius:"16px",bg:"#ffffff",text:"#1f2328",subText:"#656d76",overlay:"rgba(31, 35, 40, 0.45)",danger:"#dc2626",success:"#1a7f37"},u=class{constructor(t={},e=document.body){this.user=null;this.menuEl=null;this.settingsEl=null;this.menuCleanup=null;this.settingsCleanup=null;this.githubMsgListener=null;this.saving=!1;this.nicknameDraft="";this.onWindowFocus=()=>{this.fetchUser()};this.onVisibility=()=>{document.visibilityState==="visible"&&this.fetchUser()};this.container=e,this.opts=this.resolve(t),this.root=document.createElement("div"),this.root.className="ua-root"}static check(t){return t||z()?null:"\u672A\u68C0\u6D4B\u5230\u5FAE\u4FE1\u8BA4\u8BC1 SDK\uFF08window.WxAuth\uFF09\uFF0C\u8BF7\u5148\u5F15\u5165 wx-auth-sdk \u5E76\u8C03\u7528 WxAuth.init()"}mount(t){return this.root.isConnected?this:(t?t.appendChild(this.root):this.container instanceof ShadowRoot?this.container.appendChild(this.root):this.container===document.body?document.body.appendChild(this.root):this.container.appendChild(this.root),this.applyTheme(),this.render(),this.fetchUser(),window.addEventListener("focus",this.onWindowFocus),document.addEventListener("visibilitychange",this.onVisibility),this)}unmount(){this.destroy()}async login(){return this.triggerLogin()}async refresh(){await this.fetchUser()}destroy(){this.closeMenu(),this.closeSettings(),this.githubMsgListener&&(window.removeEventListener("message",this.githubMsgListener),this.githubMsgListener=null),window.removeEventListener("focus",this.onWindowFocus),document.removeEventListener("visibilitychange",this.onVisibility),this.root.remove()}resolve(t){let e=t.sdk??z(),i=t.apiBase!==void 0&&t.apiBase!==""?t.apiBase:"https://wx-auth.shenzjd.com";return{sdk:e,apiBase:i,fixed:t.fixed??!0,offset:t.offset??"1rem 1.5rem",size:t.size??ee.size,zIndex:t.zIndex??12e3,theme:{...ee,...t.theme??{}},onLogin:t.onLogin,onLogout:t.onLogout,onGithubBound:t.onGithubBound}}applyTheme(){let t=this.opts.theme,e=this.root.style;e.setProperty("--ua-btn-bg",t.btnBg),e.setProperty("--ua-size",t.size),e.setProperty("--ua-accent",t.accent),e.setProperty("--ua-btn-border",t.btnBorder),e.setProperty("--ua-radius",t.radius),e.setProperty("--ua-bg",t.bg),e.setProperty("--ua-text",t.text),e.setProperty("--ua-sub",t.subText),e.setProperty("--ua-overlay",t.overlay),e.setProperty("--ua-danger",t.danger),e.setProperty("--ua-success",t.success)}async triggerLogin(){let t=this.opts.sdk;if(!t)return console.warn("[UserAvatar] \u672A\u627E\u5230\u5FAE\u4FE1\u8BA4\u8BC1 SDK"),!1;let e=await t.requireAuth();return e&&(await this.fetchUser(),this.user&&this.opts.onLogin?.(this.user)),e}async logout(){let t=this.opts.sdk;t?.revoke?await t.revoke():(t?.clearToken(),V()),this.user=null,this.closeMenu(),this.closeSettings(),this.render(),this.opts.onLogout?.()}async fetchUser(){let t=w();if(!t){this.user=null,this.render();return}try{let e=this.opts.apiBase||window.location.origin,n=await(await fetch(`${e}/api/auth/userinfo?token=${encodeURIComponent(t)}`)).json();this.user=n.authenticated&&n.user?n.user:null}catch(e){console.error("[UserAvatar] \u62C9\u53D6\u7528\u6237\u8BE6\u60C5\u5931\u8D25",e),this.user=null}this.render()}async saveNickname(){let t=w(),e=this.nicknameDraft.trim();if(t){if(e.length<2||e.length>20){this.setMsg("\u6635\u79F0\u9700\u4E3A 2-20 \u4E2A\u5B57\u7B26");return}if(!this.saving){this.saving=!0,this.updateSaveBtn(),this.setMsg("");try{let i=this.opts.apiBase||window.location.origin,s=await(await fetch(`${i}/api/auth/profile`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t,action:"set-nickname",nickname:e})})).json();s.success?(this.setMsg("\u5DF2\u4FDD\u5B58"),this.nicknameDraft=e,await this.fetchUser()):this.setMsg(s.message||"\u4FDD\u5B58\u5931\u8D25")}catch(i){console.error("[UserAvatar] \u4FDD\u5B58\u6635\u79F0\u5931\u8D25",i),this.setMsg("\u4FDD\u5B58\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5")}finally{this.saving=!1,this.updateSaveBtn()}}}}async unbindGithub(){let t=w();if(t)try{let e=this.opts.apiBase||window.location.origin,n=await(await fetch(`${e}/api/auth/profile`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({token:t,action:"unbind-github"})})).json();n.success?await this.fetchUser():window.alert(n.message||"\u89E3\u7ED1\u5931\u8D25")}catch(e){console.error("[UserAvatar] \u89E3\u7ED1\u5931\u8D25",e),window.alert("\u89E3\u7ED1\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5")}}render(){this.root.innerHTML="",this.menuEl=null,this.settingsEl=null;let t=this.opts.fixed?`position:fixed;top:${this.offsetTop()};right:${this.offsetRight()};z-index:${this.opts.zIndex}`:"";this.root.innerHTML=`
    ...
    `;let n=r=>{r.composedPath().includes(this.root)||this.closeMenu()},s=r=>{r.key==="Escape"&&this.closeMenu()};document.addEventListener("mousedown",n),document.addEventListener("keydown",s),this.menuCleanup=()=>{document.removeEventListener("mousedown",n),document.removeEventListener("keydown",s)},e.querySelector('[data-action="settings"]')?.addEventListener("click",()=>{this.openSettings()}),e.querySelector('[data-action="logout"]')?.addEventListener("click",()=>{this.logout()}),this.root.appendChild(e),this.menuEl=e}closeMenu(){this.menuEl?.remove(),this.menuEl=null,this.menuCleanup?.(),this.menuCleanup=null}openSettings(){let t=this.user;if(!t)return;this.closeMenu(),this.closeSettings(),this.nicknameDraft=t.nickname||"";let e=document.createElement("div");e.className="ua-mask",e.style.zIndex=String(this.opts.zIndex+10),e.innerHTML=this.buildSettingsHtml(t),this.settingsEl=e,this.root.appendChild(e),this.bindSettingsEvents(e);let i=s=>{s.composedPath()[0]===e&&this.closeSettings()},n=s=>{s.key==="Escape"&&this.closeSettings()};document.addEventListener("mousedown",i),document.addEventListener("keydown",n),this.settingsCleanup=()=>{document.removeEventListener("mousedown",i),document.removeEventListener("keydown",n)}}buildSettingsHtml(t){let e=t.headimgurl||t.github?.avatar,i=e?`<img class="ua-big-avatar" src="${f(e)}" alt="" referrerpolicy="no-referrer" />`:`<div class="ua-big-avatar ua-big-avatar-fallback">${c((t.nickname||t.github?.login||"?").charAt(0).toUpperCase())}</div>`,n=t.github?`
        ...
        <div class="ua-github-unbound">
          ...
          <button type="button" class="ua-gh-bind" data-action="bind">${F}<span>\u7ED1\u5B9A GitHub</span></button>
        </div>`;return`
      <div class="ua-dialog" role="dialog" aria-modal="true" aria-label="\u8BBE\u7F6E">
        ...
        <div class="ua-dialog-body">
          ...
          <div class="ua-section">
            <div class="ua-section-title">${F}<span>GitHub</span></div>
            ${n}
          </div>
...
}`;var I="user-avatar",qe="__USER_AVATAR_OPTIONS__";function Te(){return window[qe]}function Ce(o,t,e){let i=o.getAttribute(t);return i===null?e:i===""||i==="true"||i==="1"}function Se(o,t,e){let i=o.getAttribute(t);if(i===null||i==="")return e;let n=Number(i);return Number.isFinite(n)?n:e}var ie=[["theme-btn-bg","btnBg"],["theme-size","size"],["theme-accent","accent"],["theme-btn-border","btnBorder"],["theme-radius","radius"],["theme-bg","bg"],["theme-text","text"],["theme-sub-text","subText"],["theme-overlay","overlay"],["theme-danger","danger"],["theme-success","success"]],y=class extends HTMLElement{constructor(){super();this.widget=null;this.pollTimer=null;this.shadow=this.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=te,this.shadow.appendChild(e)}static get observedAttributes(){return["api-base","fixed","offset","size","z-index",...ie.map(([e])=>e)]}connectedCallback(){this.mountWidget(),u.check()!==null&&this.startPolling()}disconnectedCallback(){this.stopPolling(),this.widget?.unmount(),this.widget=null}attributeChangedCallback(){this.isConnected&&(this.stopPolling(),this.mountWidget(),u.check()!==null&&this.startPolling())}startPolling(){this.pollTimer||(this.pollTimer=setInterval(()=>{u.check()===null&&(this.stopPolling(),this.mountWidget())},400))}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}mountWidget(){this.widget?.unmount();let e=u.check();e&&console.warn(`[${I}] ${e}`),this.widget=new u(this.buildOptions(),this.shadow),this.widget.mount()}buildOptions(){let e=Te()??{},i=s=>this.getAttribute(s),n={};for(let[s,r]of ie){let d=i(s);d!==null&&(n[r]=d)}return{...e,apiBase:i("api-base")??e.apiBase,fixed:Ce(this,"fixed",e.fixed??!0),offset:i("offset")??e.offset,size:i("size")??e.size,zIndex:Se(this,"z-index",e.zIndex??12e3),theme:{...e.theme??{},...n},onLogin:e.onLogin,onLogout:e.onLogout,onGithubBound:e.onGithubBound}}};customElements.get(I)||customElements.define(I,y);})();
