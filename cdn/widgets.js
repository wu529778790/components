...
`;var O="floating-qr",Ke="__FLOATING_QR_OPTIONS__",ce="__floatingQrAutoInjected__",Ve="(max-width: 767px)";function Je(){return window[Ke]}function ue(o,e,t){let n=o.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}function Xe(o,e,t){let n=o.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var he=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"]];function Ze(o){if(o===null)return null;let e=o.trim().toLowerCase();return e===""||e==="none"||e==="off"?[]:o.split(",").map(t=>t.trim()).filter(Boolean).map(t=>{let n=/github\.com/i.test(t)?"github":/t\.me/i.test(t)?"tg":/x\.com|twitter\.com/i.test(t)?"x":void 0;return{href:t,icon:n,title:n}})}var k=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=de,this.shadow.appendChild(t)}static get observedAttributes(){return["position","close-persistence","hide-on-mobile","z-index","wechat-src","wechat-title","wechat-desc","donate-src","donate-title","donate-desc","link-hrefs",...he.map(([t])=>t)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}render(){if(!this.isConnected)return;let t=this.buildOptions();t.hideOnMobile&&window.matchMedia?.(Ve)?.matches||(this.widget?.destroy(),this.widget=new M(t,this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let t=Je()??{},n=l=>this.getAttribute(l),i={};for(let[l,c]of he){let d=n(l);d!==null&&(i[c]=d)}let r=(l,c)=>{let d=n(`${l}-src`),u=n(`${l}-title`),h=n(`${l}-desc`);if(d===null&&u===null&&h===null)return c;let p={};return d!==null&&(p.src=d),u!==null&&(p.title=u),h!==null&&(p.desc=h),p},a=n("link-hrefs"),s=Ze(a);return{...t,position:n("position")??t.position,closePersistence:ue(this,"close-persistence",t.closePersistence??!1),hideOnMobile:ue(this,"hide-on-mobile",t.hideOnMobile??!0),zIndex:Xe(this,"z-index",t.zIndex??9999),theme:{...t.theme??{},...i},wechat:r("wechat",t.wechat),donate:r("donate",t.donate),links:s??t.links}}};function pe(){if(document.documentElement?.getAttribute("data-fq-auto")==="false"||document.querySelector(O)||window[ce])return;window[ce]=!0;let e=document.createElement(O);document.body.appendChild(e)}customElements.get(O)||(customElements.define(O,k),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",pe):pe());var et="\u5C0F\u6C34\u7BA1\u670D\u52A1\u5668\u625B\u4E0D\u4F4F\u4E86\uFF0C\u5982\u679C\u672C\u7AD9\u5BF9\u4F60\u6709\u7528\u5C31\u652F\u6301\u4E00\u4E0B\uFF0C\u8BA9\u5B83\u518D\u591A\u625B\u51E0\u5929\u3002",tt={src:"https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/blog/imgx-20260817-165134-105w.png",alt:"\u8D5E\u8D4F\u7801"},nt={bg:"#fff",accent:"#185fa5",radius:"16px",border:"rgba(0, 0, 0, 0.1)",overlay:"rgba(0, 0, 0, 0.4)",titleColor:"#1f1f1f",textColor:"#555"},E=class{constructor(e={},t=document.body){this.mask=null;this.closeBtn=null;this.timer=null;this.escHandler=null;this.handleClose=()=>{this.close()};this.handleMaskClick=e=>{e.target===this.mask&&this.close()};this.opts=this.resolve(e),this.container=t;let n=()=>this.render();this.opts.delay>0?this.timer=setTimeout(n,this.opts.delay):n()}isOpen(){return this.mask!==null&&this.mask.isConnected}show(){this.isOpen()||(this.timer&&(clearTimeout(this.timer),this.timer=null),this.render())}close(){this.destroy(),this.opts.onClose?.()}destroy(){this.timer&&(clearTimeout(this.timer),this.timer=null),this.escHandler&&(document.removeEventListener("keydown",this.escHandler),this.escHandler=null),this.closeBtn?.removeEventListener("click",this.handleClose),this.closeBtn=null,this.mask?.remove(),this.mask=null}resolve(e){let t=e.qr??tt;return{title:e.title??"\u5C0F\u6C34\u7BA1\u8BF7\u6C42\u652F\u63F4",content:e.content??et,contentHtml:e.contentHtml??"",qr:{src:t.src,alt:t.alt??"\u8D5E\u8D4F\u7801"},width:e.width??380,maskClosable:e.maskClosable??!0,closeOnEsc:e.closeOnEsc??!0,showClose:e.showClose??!0,delay:e.delay??0,zIndex:e.zIndex??1e4,theme:{...nt,...e.theme??{}},onClose:e.onClose}}render(){let{width:e,zIndex:t,theme:n,showClose:i,maskClosable:r}=this.opts,a=document.createElement("div");a.className="fm-mask",a.style.zIndex=String(t),a.style.setProperty("--fm-overlay",n.overlay),a.style.setProperty("--fm-bg",n.bg),a.style.setProperty("--fm-accent",n.accent),a.style.setProperty("--fm-radius",n.radius),a.style.setProperty("--fm-border",n.border),a.style.setProperty("--fm-title-color",n.titleColor),a.style.setProperty("--fm-text-color",n.textColor),a.style.setProperty("--fm-width",`${e}px`),r&&a.addEventListener("click",this.handleMaskClick),a.innerHTML=`
    ...
    `}},it='<svg viewBox="0 0 24 24" width="14" height="14" aria-hidden="true" focusable="false"><path d="M6 6l12 12M18 6L6 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>';function W(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function D(o){return W(o)}var me=`.fm-mask {
