...
`;var H="floating-modal",rt="__FLOATING_MODAL_OPTIONS__",me="__floatingModalAutoInjected__";function at(){return window[rt]}function z(o,e,t){let n=o.getAttribute(e);return n===null?t:n===""||n==="true"||n==="1"}function j(o,e,t){let n=o.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var ge=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"],["theme-overlay","overlay"],["theme-title-color","titleColor"],["theme-text-color","textColor"]],L=class extends HTMLElement{constructor(){super();this.widget=null;this.raf=0;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=pe,this.shadow.appendChild(t)}static get observedAttributes(){return["auto-show","title","content","content-html","qr-src","qr-alt","width","mask-closable","close-on-esc","show-close","delay","z-index",...ge.map(([t])=>t)]}connectedCallback(){this.renderSoon()}disconnectedCallback(){cancelAnimationFrame(this.raf),this.widget?.destroy(),this.widget=null}attributeChangedCallback(){this.isConnected&&this.renderSoon()}show(){this.widget?.isOpen()||(this.widget?.destroy(),this.widget=new E(this.buildOptions(),this.shadow))}close(){this.widget?.close()}render(){this.isConnected&&z(this,"auto-show",!0)&&(this.widget?.destroy(),this.widget=new E(this.buildOptions(),this.shadow))}renderSoon(){cancelAnimationFrame(this.raf),this.raf=requestAnimationFrame(()=>this.render())}buildOptions(){let t=at()??{},n=l=>this.getAttribute(l),i={};for(let[l,c]of ge){let d=n(l);d!==null&&(i[c]=d)}let r=n("qr-src"),a=n("qr-alt"),s=r===null&&a===null?t.qr:{src:r??t.qr?.src??"",alt:a??t.qr?.alt};return{...t,title:n("title")??t.title,content:n("content")??t.content,contentHtml:n("content-html")??t.contentHtml,qr:s,width:j(this,"width",t.width??380),maskClosable:z(this,"mask-closable",t.maskClosable??!0),closeOnEsc:z(this,"close-on-esc",t.closeOnEsc??!0),showClose:z(this,"show-close",t.showClose??!0),delay:j(this,"delay",t.delay??0),zIndex:j(this,"z-index",t.zIndex??1e4),theme:{...t.theme??{},...i}}}};function fe(){if(document.documentElement?.getAttribute("data-fm-auto")==="false"||document.querySelector(H)||window[me])return;window[me]=!0;let e=document.createElement(H);document.body.appendChild(e)}customElements.get(H)||(customElements.define(H,L),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",fe):fe());var st="https://cdn.jsdmirror.com/gh/wu529778790/img.shenzjd.com@master/reward-unlock-qr.jpg",lt="\u5E2E\u5E2E\u5C0F\u6C34\u7BA1\u670D\u52A1\u5668\u5427",dt="\u670D\u52A1\u5668\u6210\u672C\u4E0D\u5C0F\uFF0C\u5982\u679C\u89C9\u5F97\u597D\u7528\uFF0C\u5FAE\u4FE1\u626B\u7801\u770B\u4E2A\u89C6\u9891\u652F\u6301\u4E00\u4E0B\u5427\u3002",ct="\u5FAE\u4FE1\u626B\u7801\uFF0C\u5728\u5C0F\u7A0B\u5E8F\u5185\u89C2\u770B\u89C6\u9891",ut="\u4E0B\u6B21\u4E00\u5B9A",ht="\u770B\u5B8C\u5566\uFF0C\u652F\u6301\u4F5C\u8005",pt={bg:"#fff",accent:"#185fa5",radius:"16px",border:"rgba(0, 0, 0, 0.1)",overlay:"rgba(0, 0, 0, 0.4)",titleColor:"#1f1f1f",textColor:"#555"},R=class{constructor(e={},t=document.body){this.mask=null;this.status="idle";this.escHandler=null;this.destroyed=!1;this.opts=this.resolve(e),this.container=t}getState(){return this.status}isOpen(){return this.mask!==null&&this.mask.isConnected}unlock(){return this.show(),Promise.resolve({ok:!0,ticket:null,grant:null})}show(){this.destroyed||this.isOpen()||(this.render(),this.status="open")}close(){this.teardown()}destroy(){this.destroyed=!0,this.teardown()}resolve(e){return{qrSrc:e.qrSrc??st,title:e.title??lt,content:e.content??dt,contentHtml:e.contentHtml??"",width:e.width??380,zIndex:e.zIndex??1e4,theme:{...pt,...e.theme??{}}}}render(){let{width:e,zIndex:t,theme:n}=this.opts,i=document.createElement("div");i.className="fu-mask",i.style.zIndex=String(t),i.style.setProperty("--fu-overlay",n.overlay),i.style.setProperty("--fu-bg",n.bg),i.style.setProperty("--fu-accent",n.accent),i.style.setProperty("--fu-radius",n.radius),i.style.setProperty("--fu-border",n.border),i.style.setProperty("--fu-title-color",n.titleColor),i.style.setProperty("--fu-text-color",n.textColor),i.style.setProperty("--fu-width",`${e}px`),i.innerHTML=`
      <div class="fu-modal" role="dialog" aria-modal="true" aria-label="${be(this.opts.title)}">
        ...
        <p class="fu-title">${y(this.opts.title)}</p>
        <div class="fu-content">${this.buildContent()}</div>
        <div class="fu-qr"><img class="fu-qr-img" alt="\u652F\u6301\u4E8C\u7EF4\u7801" src="${be(this.opts.qrSrc)}" /></div>
        <div class="fu-hint">${y(ct)}</div>
        <div class="fu-actions">
          <button class="fu-btn fu-btn-ghost" type="button">${y(ut)}</button>
          <button class="fu-btn fu-btn-primary" type="button">${y(ht)}</button>
        </div>
      </div>
    `,i.querySelector(".fu-close")?.addEventListener("click",()=>this.close()),i.querySelector(".fu-btn-ghost")?.addEventListener("click",()=>this.close()),i.querySelector(".fu-btn-primary")?.addEventListener("click",()=>this.close()),i.addEventListener("click",r=>{r.target===i&&this.close()}),this.escHandler=r=>{r.key==="Escape"&&this.close()},document.addEventListener("keydown",this.escHandler),this.container.appendChild(i),this.mask=i,mt()}teardown(){this.escHandler&&(document.removeEventListener("keydown",this.escHandler),this.escHandler=null),this.mask?.remove(),this.mask=null,this.status="idle",gt()}buildContent(){return this.opts.contentHtml?this.opts.contentHtml:y(this.opts.content).replace(/\n/g,"<br>")}},q=0,x=null;function mt(){if(q+=1,x)return;let e=document.body.style;x={top:e.top,left:e.left,width:e.width,position:e.position,scrollY:window.scrollY},e.top=`-${x.scrollY}px`,e.left="0",e.width="100%",e.position="fixed"}function gt(){if(q<=0||(q-=1,q>0||!x))return;let e=document.body.style,t=x;x=null,e.top=t.top,e.left=t.left,e.width=t.width,e.position=t.position,t.scrollY>0&&requestAnimationFrame(()=>window.scrollTo(0,t.scrollY))}function y(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function be(o){return y(o)}var ve=`.fu-mask {
...
`;var xe="floating-unlock",bt="__FLOATING_UNLOCK_OPTIONS__";function vt(){return window[bt]}function ye(o,e,t){let n=o.getAttribute(e);if(n===null||n==="")return t;let i=Number(n);return Number.isFinite(i)?i:t}var we=[["theme-bg","bg"],["theme-accent","accent"],["theme-radius","radius"],["theme-border","border"],["theme-overlay","overlay"],["theme-title-color","titleColor"],["theme-text-color","textColor"]],T=class extends HTMLElement{constructor(){super();this.widget=null;this.shadow=this.attachShadow({mode:"open"});let t=document.createElement("style");t.textContent=ve,this.shadow.appendChild(t)}static get observedAttributes(){return["qr-src","title","content","content-html","width","z-index",...we.map(([t])=>t)]}disconnectedCallback(){this.widget?.destroy(),this.widget=null}unlock(){return this.ensureWidget().show(),Promise.resolve({ok:!0,ticket:null,grant:null})}show(){this.ensureWidget().show()}close(){this.widget?.close()}ensureWidget(){return this.widget?.destroy(),this.widget=new R(this.buildOptions(),this.shadow),this.widget}buildOptions(){let t=vt()??{},n=r=>this.getAttribute(r),i={};for(let[r,a]of we){let s=n(r);s!==null&&(i[a]=s)}return{...t,qrSrc:n("qr-src")??t.qrSrc,title:n("title")??t.title,content:n("content")??t.content,contentHtml:n("content-html")??t.contentHtml,width:ye(this,"width",t.width??380),zIndex:ye(this,"z-index",t.zIndex??1e4),theme:{...t.theme??{},...i}}}};customElements.get(xe)||customElements.define(xe,T);function Q(){if(typeof window<"u")return window.WxAuth}var B=`/* ============================================================
  user-avatar \u7EC4\u4EF6\u6837\u5F0F
